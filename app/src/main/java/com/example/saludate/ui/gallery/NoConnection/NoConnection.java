package com.example.saludate.ui.gallery.NoConnection;
...
public class NoConnection extends Fragment {
    ...
    private NoConnectionViewModel mViewModel;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(NoConnectionViewModel.class);
